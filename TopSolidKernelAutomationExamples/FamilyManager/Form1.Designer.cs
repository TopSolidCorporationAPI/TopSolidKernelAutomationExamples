namespace FamilyManager
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btCreateFamily = new System.Windows.Forms.Button();
			...
			this.tableLayoutPanel2.Controls.Add(this.btCreateFamily, 1, 3);
			...
			// btCreateFamily
			// 
			this.btCreateFamily.Dock = System.Windows.Forms.DockStyle.Fill;
			this.btCreateFamily.Location = new System.Drawing.Point(286, 126);
			this.btCreateFamily.Name = "btCreateFamily";
			this.btCreateFamily.Size = new System.Drawing.Size(166, 35);
			this.btCreateFamily.TabIndex = 4;
			this.btCreateFamily.Text = "Create Family From Single";
			this.btCreateFamily.UseVisualStyleBackColor = true;
			this.btCreateFamily.Click += new System.EventHandler(this.btCreateFamily_Click);
			// 
			// pdmTreeView1
			// 
		...
		private System.Windows.Forms.Button btCreateFamily;
	}
}
